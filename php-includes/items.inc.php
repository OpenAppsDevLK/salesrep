...
// Select the user and assign permission (On/OFF items)...          
...
$stmt_pid_1112->bind_result($cp_users_id, $cp_users_firstname, $cp_users_lastname, $cp_userpermission_permission_id, $cp_userpermission_uid, $cp_userpermission_OnOff);
...
$sql = "SELECT COUNT(id) FROM cp_Items";
...
$sql = "SELECT * FROM cp_Items ORDER BY id DESC $limit";
...
if($last != 1){
	...
	if ($pagenum > 1) {
        $previous = $pagenum - 1;
		$paginationCtrls .= '<li><a href="index.php?page=Items&PageNo=1">&laquo;&laquo;</a></li>'
                                 .'<li><a href="index.php?page=Items&PageNo='.$previous.'">&laquo;</a></li>';
                         
		// Render clickable number links that should appear on the left of the target page number
		for($i = $pagenum-2; $i < $pagenum; $i++){
			if($i > 0){
		        $paginationCtrls .= '<li><a href="index.php?page=Items&PageNo='.$i.'">'.$i.'</a></li>';
			}
	    }
    }
    ...
    if ($pagenum != $last) {
        $next = $pagenum + 1;
        $paginationCtrls .= '<li><a href="index.php?page=Items&PageNo='.$next.'">&raquo;</a></li> '
                         .'<li><a href="index.php?page=Items&PageNo='.$last.'">&raquo;&raquo;</a></li>'
                         .'</ul>';
    }
}
        ...
        <div class="box-body">
         ...
         <!-- Search Form -->       
                ...
                <form style="margin-bottom: 10px;" role="form" method="get" action="" class="form-inline">
                    ...
                    <input style="margin-top: 10px;" class="form-control" type="text" name="SearchKey" value="" placeholder="Item ID or Name"/>
                    <input style="margin-top: 10px;" class="btn btn-primary btn-flat" type="submit" onclick="" value="Search">
                    <a style="margin-top: 10px;" href="index.php?page=Items&PageNo=1" class="btn btn-info btn-flat" >View All</a>
                 
                    <button style="margin-top: 10px;" type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#changeMsg">Add New Item</button>                

                </form>
             
<?php
//linked with addcompany.fn.php
$Add_Items = AddItems();
  ...
  <div class="modal-dialog" role="document">
    ...
    <form id="form_addstudent" style="" role="form" action="" method="post" >
                      ...
                      <label>Item Code</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="text" name="txt_item_code" value="<?php echo(rand(10000,1000000)); ?>" class="form-control ">
                       </div>
                      <p>Note: You can use your own code.</p>
                    </div>   
                      ...
                      <label>Item Name</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="text" name="txt_item_name" value="" class="form-control" required>
                       </div>
                    </div>  
                      ...
                      <label>Notes</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <textarea class="form-control" name="txt_item_notes" rows="4"></textarea>
                       </div>
                    </div>  
                      ...
                      <label>Cost Price</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="text" name="txt_cost_price" value="" class="form-control">
                       </div>
                    </div>
                      ...
                      <label>Sales Price</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="text" name="txt_sales_price" value="" class="form-control" required>
                       </div>
                    </div> 
      ...
      <div class="modal-footer">
        <input  style="" class="btn  btn btn-outline btn-flat"  type="submit"  name="btn_item_submit" value="Add Item">
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td >  
                                ...
                                <a style="margin-top: 10px;" title="Update Item Details" href="index.php?page=EditItem&item_ID=<?php echo $row['id'] ?>&PageNo=<?php echo $PNo; ?>" class="btn btn-info btn-flat glyphicon glyphicon-pencil" ></a>
...
<SCRIPT LANGUAGE="JavaScript">
                ...
                deleteBtn.addEventListener('click', (e) => {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            form.action = 'actions/delete_item.php?page=Customer&PageNo=<?php echo (int)$PNo; ?>';
                            form.submit();
 ...
 <?php
                       ...
                       $sql_2 = "SELECT * FROM cp_Items WHERE item_code LIKE '%{$SearchKey}%' OR name LIKE '%{$SearchKey}%'";
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td >  
                                ...
                                <a style="margin-top: 10px;" title="Update Company Details" href="index.php?page=UpdateItem&item_ID=<?php echo $row['id'] ?>&PageNo=<?php echo $PNo; ?>" class="btn btn-info btn-flat glyphicon glyphicon-pencil" ></a>
