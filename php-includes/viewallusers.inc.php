...
$sql = "SELECT u.id, u.username, u.password, u.firstname, u.lastname, u.rep_id, u.can_view_all_inv, r.rep_name
FROM cp_users u
LEFT JOIN cp_rep r ON u.rep_id = r.id
$limit";
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td>
                                ...
                                <i class="glyphicon glyphicon-check"></i> Assign Permissions
                                </a>                          
                        ...
                        <td><?php echo htmlspecialchars($row['can_view_all_inv'] == 1 ? 'YES' : 'NO'); ?></td>
