...
// Select the user and assign permission (On/OFF Customers)...          
...
$stmt_pid_1111->bind_result($cp_users_id, $cp_users_firstname, $cp_users_lastname, $cp_userpermission_permission_id, $cp_userpermission_uid, $cp_userpermission_OnOff);
...
$sql = "SELECT COUNT(id) FROM cp_customers";
...
$sql = "SELECT * FROM cp_customers ORDER BY com_name ASC $limit";
...
if($last != 1){
	...
	if ($pagenum > 1) {
        $previous = $pagenum - 1;
		$paginationCtrls .= '<li><a href="index.php?page=Customers&PageNo=1">&laquo;&laquo;</a></li>'
                                 .'<li><a href="index.php?page=Customers&PageNo='.$previous.'">&laquo;</a></li>';
                         
		// Render clickable number links that should appear on the left of the target page number
		for($i = $pagenum-2; $i < $pagenum; $i++){
			if($i > 0){
		        $paginationCtrls .= '<li><a href="index.php?page=Customers&PageNo='.$i.'">'.$i.'</a></li>';
			}
	    }
    }
    ...
    if ($pagenum != $last) {
        $next = $pagenum + 1;
        $paginationCtrls .= '<li><a href="index.php?page=Customers&PageNo='.$next.'">&raquo;</a></li> '
                         .'<li><a href="index.php?page=Customers&PageNo='.$last.'">&raquo;&raquo;</a></li>'
                         .'</ul>';
    }
}
 ...
 ?>
        ...
        <section class="content">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">All Customers List</h3>
        ...
        <div class="box-body">
         ...
         <!-- Search Form -->       
                ...
                <form style="margin-bottom: 10px;" role="form" method="get" action="" class="form-inline">
                    ...
                    <input style="margin-top: 10px;" class="form-control" type="text" name="SearchKey" value="" placeholder="Customer ID or Name"/>
                    <input style="margin-top: 10px;" class="btn btn-primary btn-flat" type="submit" onclick="" value="Search">
                    <a style="margin-top: 10px;" href="index.php?page=Customers&PageNo=1" class="btn btn-info btn-flat" >View All</a>
                 
                    <button style="margin-top: 10px;" type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#changeMsg">Add a Customer</button>                

                </form>
             
<?php
//linked with addcustomer.fn.php
$Add_Customer = AddCustomer();

?>
  <!-- Modal Window for Add a Customer-->
<div class="modal fade modal-success" id="changeMsg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form id="form_addstudent" style="" role="form" action="" method="post" >
                      ...
                      <label>Customers ID</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="number" name="txt_com_id" value="<?php echo(rand(1000,10000)); ?>" class="form-control ">
                       </div>
                    </div>   
                      ...
                      <label>Customers Name</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="text" name="txt_com_name" value="" class="form-control" required>
                       </div>
                    </div>  
                      ...
                      <label>Contact No</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="number" name="txt_com_tele" value="" class="form-control ">
                       </div>
                    </div>  
                      ...
                      <label>Address</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <textarea class="form-control" name="txt_com_address" rows="4"></textarea>
                       </div>
                    </div>  
                      ...
                      <label>Notes</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <textarea class="form-control" name="txt_com_notes" rows="4"></textarea>
                       </div>
                    </div>             
      ...
      <div class="modal-footer">
        <input  style="" class="btn  btn btn-outline btn-flat"  type="submit"  name="btn_com_submit" value="Add Customer">
 ...
 ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td><a href="tel:<?php echo $row['com_tele']; ?>"><?php echo $row['com_tele']; ?></a></td>
                         <td >  

                                <a style="margin-top: 10px;" title="Update Company Details" href="index.php?page=UpdateCustomer&CustomerID=<?php echo $row['id'] ?>&PageNo=<?php echo $PNo; ?>" class="btn btn-info btn-flat glyphicon glyphicon-pencil" ></a>
...
<SCRIPT LANGUAGE="JavaScript">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (deleteBtn) {
                deleteBtn.addEventListener('click', (e) => {
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: 'Do you want to delete the selected customers?',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            form.action = 'actions/delete_customer.php?page=Customer&PageNo=<?php echo (int)$PNo; ?>';
                            form.submit();
 ...
 <?php
                       ...
                       $sql_2 = "SELECT * FROM cp_customers WHERE com_id LIKE '%{$SearchKey}%' OR com_name LIKE '%{$SearchKey}%'";
                 ...
                 <tr>
                        ...
                        <td><input name="check_list[]" type="checkbox" style="width:15px; height: 15px; border-radius: 0px;" id="check_list" value="<?php echo $row['id'] ?>" /></td>
                         ...
                         <td >  
                                ...
                                <a style="margin-top: 10px;" title="Update Company Details" href="index.php?page=UpdateCustomer&CustomerID=<?php echo $row['id'] ?>&SearchKey=<?php echo $_GET['SearchKey'] ?>" class="btn btn-info btn-flat glyphicon glyphicon-pencil" ></a>
