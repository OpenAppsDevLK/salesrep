...
// Select the user and assign permission... (ON/OFF Rep )          
...
$stmt_pid_1113->bind_result($cp_users_id, $cp_users_firstname, $cp_users_lastname, $cp_userpermission_permission_id, $cp_userpermission_uid, $cp_userpermission_OnOff);
...
$sql = "SELECT COUNT(id) FROM cp_rep";
...
$sql = "SELECT * FROM cp_rep ORDER BY rep_name ASC $limit";
...
if($last != 1){
	...
	if ($pagenum > 1) {
        $previous = $pagenum - 1;
		$paginationCtrls .= '<li><a href="index.php?page=Rep&PageNo=1">&laquo;&laquo;</a></li>'
                                 .'<li><a href="index.php?page=Rep&PageNo='.$previous.'">&laquo;</a></li>';
                         
		// Render clickable number links that should appear on the left of the target page number
		for($i = $pagenum-2; $i < $pagenum; $i++){
			if($i > 0){
		        $paginationCtrls .= '<li><a href="index.php?page=Rep&PageNo='.$i.'">'.$i.'</a></li>';
			}
	    }
    }
    ...
    if ($pagenum != $last) {
        $next = $pagenum + 1;
        $paginationCtrls .= '<li><a href="index.php?page=Rep&PageNo='.$next.'">&raquo;</a></li> '
                         .'<li><a href="index.php?page=Rep&PageNo='.$last.'">&raquo;&raquo;</a></li>'
                         .'</ul>';
    }
}
 ...
 ?>
        ...
        <section class="content">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Representatives List</h3>
        ...
        <div class="box-body">
         ...
         <!-- Search Form -->       
                ...
                <form style="margin-bottom: 10px;" role="form" method="get" action="" class="form-inline">
                    <input type="hidden" name="page" value="Rep">
                    <input style="margin-top: 10px;" class="form-control" type="text" name="SearchKey" value="" placeholder="Rep Name"/>
                    <input style="margin-top: 10px;" class="btn btn-primary btn-flat" type="submit" onclick="" value="Search">
                    <a style="margin-top: 10px;" href="index.php?page=Rep&PageNo=1" class="btn btn-info btn-flat" >View All</a>
                 
                    <button style="margin-top: 10px;" type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#changeMsg">Add New Rep</button>                

                </form>
             
<?php
//linked with add_rep.fn.php
$ADDREP = addrep();

?>
  <!-- Modal Window for Rep -->
<div class="modal fade modal-success" id="changeMsg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form id="form_addstudent" style="" role="form" action="<?php $ADDREP;  ?>" method="post" >

      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Add New REP</h4>
      </div>
                      ...
                      <label>Rep Name</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="text" name="txt_rep_name" value="" class="form-control" required>
                       </div>
                    </div>  
                      ...
                      <label>Rep Address</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <textarea class="form-control" name="txt_rep_address" rows="4"></textarea>
                       </div>
                    </div>  
                      ...
                      <label>Mobile No01</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="number" name="txt_rep_mob01" value="" class="form-control " required>
                       </div>
                    </div>  
                      ...
                      <label>Mobile No02</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <input type="number" name="txt_rep_mob2" value="" class="form-control ">
                       </div>
                    </div>  
                      ...
                      <label>Notes</label>
                       <div class="input-group">
                        ...
                        <i class="glyphicon glyphicon-menu-right"></i>
                           ...
                           <textarea class="form-control" name="txt_rep_notes" rows="4"></textarea>
                       </div>
                    </div>             
      ...
      <div class="modal-footer">
        <input  style="" class="btn  btn btn-outline btn-flat"  type="submit"  name="btn_rep_submit" value="Add Rep">
 ...
 ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td><a href="tel:<?php echo $row['rep_mob1']; ?>"><?php echo $row['rep_mob1']; ?></a></td>
                         <td >  

                                <a style="margin-top: 10px;" title="Update Dealer Details" href="index.php?page=UpdateRep&RepID=<?php echo $row['id'] ?>&PageNo=<?php echo $PNo; ?>" class="btn btn-info btn-flat glyphicon glyphicon-pencil" ></a>
            ...
            if (deleteBtn) {
                deleteBtn.addEventListener('click', (e) => {
                    ...
                    if (checkedBoxes.length === 0) {
                        Swal.fire({
                            title: 'No Selection',
                            text: 'Please select at least one rep to delete.',
                            icon: 'warning',
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: 'Do you want to delete the selected reps?',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            form.action = 'actions/delete_rep.php?page=Customer&PageNo=<?php echo (int)$PNo; ?>';
                            form.submit();
...
<?php
           ...
           $sql_2 = "SELECT * FROM cp_rep WHERE  rep_name LIKE '%{$SearchKey}%'";
                 ...
                 <tr>
                        ...
                        <td><input name="check_list[]" type="checkbox" style="width:15px; height: 15px; border-radius: 0px;" id="check_list" value="<?php echo $row['id'] ?>" /></td>
                         ...
                         <td >  
                                ...
                                <a style="margin-top: 10px;" title="Update Dealer Details" href="index.php?page=UpdateRep&RepID=<?php echo $row['id'] ?>&PageNo=1&SearchKey=<?php echo $_GET["SearchKey"]; ?>" class="btn btn-info btn-flat glyphicon glyphicon-pencil" ></a>
